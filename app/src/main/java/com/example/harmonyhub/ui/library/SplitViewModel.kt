...
class SplitViewModel (
    ...
    private val _stateMusic1 = MutableStateFlow<SplitUiState>(SplitUiState.Loading)
    val stateMusic1 = _stateMusic1.asStateFlow()

    private val _stateMusic2 = MutableStateFlow<SplitUiState>(SplitUiState.Loading)
